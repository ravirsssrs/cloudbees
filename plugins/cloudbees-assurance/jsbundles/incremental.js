...
require('jenkins-js-modules').whoami('undefined:incremental');
...
onSetupWizardInitialized(function(wizard) {
    var upgradePanel = require('./templates/offerIncrementalUpgradePanel.hbs');
    var installingPanel = require('./templates/installingIncrementalUpgradePanel.hbs');
    ...
    var errorTimeoutMillis = 10 * 1000;

    /* Function to obtain the state of the incremental upgrade. */
    iuState = function(handler) {
        jenkins.get('/setupWizard/installState/CB_INCREMENTAL_UPGRADE/state', function(response) {
    ...
    wizard.addActions({
        '.skip-incremental-upgrade': function() {
            jenkins.post(
                '/setupWizard/installState/CB_INCREMENTAL_UPGRADE/skip',
                {},
                function () {
                    // Proceed to next step, already calculated server side
                    wizard.showStatePanel(null);
                    // TODO: error handling
                },
                {});
        },
        '.install-incremental-upgrade': function() {
            // TODO: installation feedback should be asynchronous.
            jenkins.post(
                '/setupWizard/installState/CB_INCREMENTAL_UPGRADE/install',
                {},
                function () {
                    // Proceed to next step, already calculated server side
                    wizard.showStatePanel(null);
    ...
    wizard.addStateHandlers({
        CB_INCREMENTAL_UPGRADE: function() {
            iuState(function(data) {
                if (data.state === "OFFER") {
                    wizard.setPanel(upgradePanel, {
                        description: data.description,
                        product: data.product,
                        currentVersion: data.currentVersion,
                        offeredRevision: data.offeredRevision
                    });
                } else if (data.state === "INSTALLING") {
                    wizard.setPanel(installingPanel, {
                        description: data.description,
		...
		require('jenkins-js-modules').export(undefined, 'incremental', {});
    });


},{"./templates/installingIncrementalUpgradePanel.hbs":11,"./templates/offerIncrementalUpgradePanel.hbs":12,"jenkins-js-modules":6}],11:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('jenkins-handlebars-rt/runtimes/handlebars3_rt');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    var helper, alias1=helpers.helperMissing, alias2="function", alias3=this.escapeExpression;

  return "<div class=\"modal-header closeable\">\n  <h4 class=\"modal-title\">Upgrade Detected</h4>\n</div>\n<div class=\"modal-body\">\n  <i class=\"water-mark icon-service\"></i>\n  <div class=\"jumbotron welcome-panel upgrade-panel\">\n    <h1>Incremental Upgrade</h1>\n    <p id=\"progress-description\">"
    + alias3(((helper = (helper = helpers.description || (depth0 != null ? depth0.description : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"description","hash":{},"data":data}) : helper)))
    + "</p>\n    <div class=\"progress\" id=\"progress\">\n      <div class=\"progress-bar progress-bar-striped active\" role=\"progressbar\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width: "
...
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  ...
  return "<div class=\"modal-header closeable\">\n  <h4 class=\"modal-title\">Upgrade Detected</h4>\n</div>\n<div class=\"modal-body\">\n  <i class=\"water-mark icon-service\"></i>\n  <div class=\"jumbotron welcome-panel upgrade-panel\">\n    <h1>Incremental Upgrade Available</h1>\n    <p>Your current <strong>"
    ...
    + "</strong> version is <code>"
    + alias3(((helper = (helper = helpers.currentVersion || (depth0 != null ? depth0.currentVersion : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"currentVersion","hash":{},"data":data}) : helper)))
    + "</code>. There is a new <a href=\"https://go.cloudbees.com/docs/cloudbees-documentation/assurance-program/\" target=\"_blank\">incremental upgrade</a> (revision <code>"
    + alias3(((helper = (helper = helpers.offeredRevision || (depth0 != null ? depth0.offeredRevision : depth0)) != null ? helper : alias1),(typeof helper === alias2 ? helper.call(depth0,{"name":"offeredRevision","hash":{},"data":data}) : helper)))
    + "</code>) available for this version.</p>\n    <p>\n      If you decide to <strong>install</strong> the incremental upgrade at this point, depending on the affected plugins, an additional restart may be required at the end of the installation process.\n    </p>\n    <p>\n      If you choose to <strong>skip</strong> the upgrade in the setup wizard, the administrator can upgrade later using the Beekeeper Upgrade Assistant.\n    </p>\n  </div>\n</div>\n<div class=\"modal-footer\">\n  <button type=\"button\" class=\"btn btn-link skip-incremental-upgrade\">Skip</button>\n  <button id=\"install-plugins-button\" type=\"button\" class=\"btn btn-primary install-incremental-upgrade\">Install</button>\n</div>\n";
},"useData":true});
